...
SET @command_string = N'cmd /q /c "For /F "tokens=1 delims=" %v In (''ForFiles /P "'+'$'+'(ESCAPE_SQUOTE(SQLLOGDIR))" /m *_*_*_*.txt /d -30 2^>^&1'') do if EXIST "'+'$'+'(ESCAPE_SQUOTE(SQLLOGDIR))"\%v echo del "'+'$'+'(ESCAPE_SQUOTE(SQLLOGDIR))"\%v& del "'+'$'+'(ESCAPE_SQUOTE(SQLLOGDIR))"\%v"'

/****** Object:  Job [DBA - History and log file maintenance]    Script Date: 31/05/2021 11:38:31 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 31/05/2021 11:38:31 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [CommandLog table cleanup]    Script Date: 31/05/2021 11:38:31 AM ******/
...
WHERE StartTime < DATEADD(dd,-32,GETDATE())', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Output file cleanup]    Script Date: 31/05/2021 11:38:31 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Output file cleanup', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup and restore history cleanup]    Script Date: 31/05/2021 11:38:31 AM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Maintenace plan history cleanup]    Script Date: 31/05/2021 11:38:31 AM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Job history cleanup]    Script Date: 31/05/2021 11:38:31 AM ******/
