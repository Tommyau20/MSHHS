...
/****** Object:  Job [DBA - Database backup (FULL)]    Script Date: 19/01/2021 2:00:05 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 19/01/2021 2:00:05 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Delete old FULL backups]    Script Date: 19/01/2021 2:00:05 PM ******/
...
EXECUTE master.dbo.xp_delete_file 0,@DefaultDirectory,N''bak'',@today_minus_1_day,1', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseBackup (FULL)]    Script Date: 19/01/2021 2:00:05 PM ******/
