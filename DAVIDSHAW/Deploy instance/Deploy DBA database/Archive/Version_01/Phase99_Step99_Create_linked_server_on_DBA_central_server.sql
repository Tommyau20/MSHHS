...
DECLARE @DBA_PassWord VARCHAR(50)
SET @ServerName = '$(var_server)'
SET @DBA_PassWord = '$(var_password)' -- This marries with the password in the script to create DBA SQL login on the source server
