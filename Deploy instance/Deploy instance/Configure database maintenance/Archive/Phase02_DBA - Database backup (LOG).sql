...
/****** Object:  Job [DBA - Database backup (LOG)]    Script Date: 19/01/2021 2:00:30 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 19/01/2021 2:00:30 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Delete old LOG backups]    Script Date: 19/01/2021 2:00:30 PM ******/
...
EXECUTE master.dbo.xp_delete_file 0,@DefaultDirectory,N''trn'',@today_minus_1_day,1', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseBackup (LOG)]    Script Date: 19/01/2021 2:00:30 PM ******/
