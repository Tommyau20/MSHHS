...
/****** Object:  Job [DBA - Database backup (DIFF)]    Script Date: 19/01/2021 1:59:10 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 19/01/2021 1:59:10 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Delete old DIFF backups]    Script Date: 19/01/2021 1:59:10 PM ******/
...
EXECUTE master.dbo.xp_delete_file 0,@DefaultDirectory,N''dif'',@today_minus_1_day,1', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseBackup (DIFF)]    Script Date: 19/01/2021 1:59:10 PM ******/
